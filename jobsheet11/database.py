...
def execute_query(query: str, params: tuple = None):
    """Menjalankan query non-SELECT. 
    Mengembalikan lastrowid jika INSERT, atau jumlah baris terpengaruh untuk UPDATE/DELETE."""
    ...
    try:
        ...
        if query.strip().upper().startswith("INSERT"):
            ...
            return cursor.rowcount  # jumlah baris yang terpengaruh (untuk DELETE, UPDATE)
